...
<link rel="stylesheet" media="all and (orientation:portrait)" href="default_m.css">
<link rel="stylesheet" media="all and (orientation:landscape)" href="default_l.css">        
           ...
           <section id="s_one"> 
            	...
            	<div id="t1">
                    ...
                    <form id="form_q" style="text-align:center;" id="questions" action="comment.php" method="post"> 
                        <input name="email_address" id="emailaddress" placeholder="Email" type="email">
                        <input name="location" id="location_form" placeholder="City,State" type="text"><br>
                        <textarea name="question_text" id="questionwrapper" placeholder="Question?" ></textarea><br>
                ...
                <div class="scrolldownonee" style="position:absolute; z-index:30; width:100%; text-align:center;"><img class="scrolldownone" style=" height:auto" src="https://d2xcq4qphg1ge9.cloudfront.net/assets/17276/2089528/original_scroll_down.png"></div> 
            </section>
            <section id="s_two">
                ...
                <div id="t2">
                    ...
                    <div class="t2_2">We believe that new home<br>construction should be<br>a pleasure.</div>
            ...
            <div class="overlay_three"></div>
                <div id="t3">
                    ...
                    <div class="t3_3">Healthy, energy efficient<br>homes that save you money<br>before and after you purchase.</div>
                </div>            
            </section>     
            <section id="s_four">
            ...
            <div class="overlay_five"></div>
                ...
                <div id="t5">
                    ...
                    <div class="t5_2">Every component is crafted in<br>our temperature controlled<br>building studios to<br>exacting standards.</div>
            ...
            <div class="overlay_six"></div>
                ...
                <div id="t6">
					...
					<div>
						<img style="width:40%; height:auto" src="https://d2xcq4qphg1ge9.cloudfront.net/assets/17276/2089564/original_logo_end.png">
					</div>                    
                </div>              
